          ...
          <ModalBody>
            ...
            <div className="nk-modal-head">
              <h4 className="nk-modal-title title">
                SubCategory <small className="text-primary">#{formData.sku}</small>
              </h4>
            ...
            <div className="nk-tnx-details mt-sm-3">
              <Row className="gy-3">
                <Col lg={6}>
                  <span className="sub-text">SubCategory Name</span>
                  <span className="caption-text">{formData.name}</span>
                </Col>
                <Col lg={6}>
                  <span className="sub-text">SubCategory Price</span>
                  <span className="caption-text">$ {formData.price}</span>
                </Col>
                <Col lg={6}>
                  <span className="sub-text">SubCategory Category</span>
